...
*  [**Prep: Readings ... Get Ready for 401**](js401/class-00.md)
*  [**Node Ecosystem, TDD, CI/CD**](js401/class-01.md)
*  [**Express**](js401/class-02.md)
*  [**Express REST API**](js401/class-03.md)
*  [**Data Modeling**](js401/class-04.md)
*  [**Authentication**](js401/class-06.md)
*  [**Bearer Authorization**](js401/class-07.md)
*  [**Access Control (ACL)**](js401/class-08.md)
*  [**Authorization/Authentication**](js401/class-09.md)
*  [**Event Driven Applications**](js401/class-11.md)
*  [**Socket.io**](js401/class-12.md)
*  [**Message Queues**](js401/class-13.md)
*  [**Event Driven Architecture**](js401/class-14.md)
*  [**AWS: Cloud Servers**](js401/class-16.md)
*  [**AWS: S3 and Lambda**](js401/class-17.md)
*  [**AWS: API, Dynamo and Lambda**](js401/class-18.md)
*  [**AWS: Events**](js401/class-19.md)
*  [**Component Based UI**](js401/class-26.md)
*  [**useState() Hook**](js401/class-27.md)
*  [**Component Lifecycle**](js401/class-28.md)
*  [**Advanced State with Reducers**](js401/class-29.md)
*  [**Context API**](js401/class-31.md)
*  [**Context API - Behaviors**](js401/class-32.md)
*  [**Login and Auth**](js401/class-33.md)
*  [**API Integration**](js401/class-34.md)
*  [**Application State with Redux**](js401/class-36.md)
*  [**Redux - Combined Reducers**](js401/class-37.md)
...
*  [**Readings: Introduction to Course: Python 401**](py401/class-01.md)
*  [**Testing and Modules**](py401/class-02.md)
*  [**FileIO & Exceptions**](py401/class-03.md)
*  [**Variables, Recursion, & Pytest**](py401/class-04.md)
*  [**Data Structure and Analysis: Linked Lists**](py401/class-05.md)
...
*  [**Data Structure and Analysis: Stacks & Queues**](py401/class-10.md)
*  [**Data Analysis**](py401/class-11.md)
...
*  [**Automation**](py401/class-19.md)
*  [**Intro to Django**](py401/class-26.md)
...
*  [**API Deployment**](py401/class-34.md)
*  [****](py401/class-35.md)
*  [**DSA Review**](py401/class-36.md)
*  [**React 1**](py401/class-37.md)
*  [**React 2**](py401/class-38.md)
*  [**React 3**](py401/class-39.md)
*  [****](py401/class-40.md)
*  [**React 4**](py401/class-41.md)
*  [**Pythonisms**](py401/class-42.md)
